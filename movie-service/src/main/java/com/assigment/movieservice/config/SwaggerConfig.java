package com.assigment.movieservice.config;
...
public class SwaggerConfig {
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2).select()
        .apis(RequestHandlerSelectors.basePackage("com.assigment.movieservice.rest"))
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("MOVIE API")
        .description("This is Swagger documentation for Movie  API's").build();
  }
