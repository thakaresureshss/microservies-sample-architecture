...
public class SwaggerConfig {
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2).select()
        .apis(RequestHandlerSelectors.basePackage("com.assigment.moviecatalog.rest"))
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("Movie Catalog API")
        .description("This is Swagger documentation for Movie Catalog API's").build();
  }
