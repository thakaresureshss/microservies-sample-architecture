...
public class SwaggerConfig {
  ...
  public Docket api() {
    return new Docket(DocumentationType.SWAGGER_2).select()
        .apis(RequestHandlerSelectors.basePackage("com.assigment.castservice.rest"))
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title("Casts API")
        .description("This is Swagger documentation for Movie Cast API's").build();
  }
